...
version = release = pybpodgui_api.__version__
...
htmlhelp_basename = 'pybpodgui_api-apidoc'
...
latex_documents = [
  (master_doc, 'pybpodgui-api.tex', 'pybpodgui-api Documentation',
...
man_pages = [
    (master_doc, 'pybpodgui-api', 'pybpodgui-api Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'pybpodgui-api', 'pybpodgui-api Documentation',
   author, 'pybpodgui-api', 'One line description of project.',
   'Miscellaneous'),
]
